...
static struct clkctl_acpu_speed acpu_freq_tbl_freq[] = {
  ...
  { {1, 1},  432000,  ACPU_SCPLL, 0, 0, 1, 0x08, L2(1),   887500, 0x03006000}, //ACPU_SCPLL = 54mhZ, 8*54 = 432
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(2),   912500, 0x03006000}, //0x09 = 09, 09 * 54 = 486MHz
  { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(3),   925000, 0x03006000}, //0x0A = 10, 10 * 54 = 540MHz
  { {1, 1},  594000,  ACPU_SCPLL, 0, 0, 1, 0x0B, L2(4),   937500, 0x03006000}, //0x0B = 11, 11 * 54 = 594MHz
  { {1, 1},  648000,  ACPU_SCPLL, 0, 0, 1, 0x0C, L2(5),   950000, 0x03006000}, //0x0C = 12, 12 * 54 = 648MHz
  { {1, 1},  702000,  ACPU_SCPLL, 0, 0, 1, 0x0D, L2(6),   975000, 0x03006000}, //0x0D = 13, 13 * 54 = 702MHz
  { {1, 1},  756000,  ACPU_SCPLL, 0, 0, 1, 0x0E, L2(7),  1000000, 0x03006000}, //0x0E = 14, 14 * 54 = 756MHz
  { {1, 1},  810000,  ACPU_SCPLL, 0, 0, 1, 0x0F, L2(8),  1012500, 0x03006000}, //0x0F = 15, 15 * 54 = 810MHz
  { {1, 1},  864000,  ACPU_SCPLL, 0, 0, 1, 0x10, L2(9),  1037500, 0x03006000}, //0x10 = 16, 16 * 54 = 864MHz
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(10), 1062500, 0x03006000}, //0x11 = 17, 17 * 54 = 918MHz
  { {1, 1},  972000,  ACPU_SCPLL, 0, 0, 1, 0x12, L2(11), 1087500, 0x03006000}, //0x12 = 18, 18 * 54 = 972MHz
  { {1, 1}, 1026000,  ACPU_SCPLL, 0, 0, 1, 0x13, L2(12), 1125000, 0x03006000}, //0x13 = 19, 19 * 54 = 1026MHz
  { {1, 1}, 1080000,  ACPU_SCPLL, 0, 0, 1, 0x14, L2(13), 1137500, 0x03006000}, //0x14 = 20, 20 * 54 = 1080MHz
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(14), 1162500, 0x03006000}, //0x15 = 21, 21 * 54 = 1134MHz
  { {1, 1}, 1188000,  ACPU_SCPLL, 0, 0, 1, 0x16, L2(15), 1187500, 0x03006000}, //0x16 = 22, 22 * 54 = 1188MHz
  { {1, 1}, 1242000,  ACPU_SCPLL, 0, 0, 1, 0x17, L2(16), 1187500, 0x03006000}, //0x17 = 23, 23 * 54 = 1242MHz
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(17), 1187500, 0x03006000}, //0x18 = 24, 24 * 54 = 1296MHz
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(18), 1187500, 0x03006000}, //0x19 = 25, 25 * 54 = 1350MHz
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(19), 1200000, 0x03006000}, //0x1A = 26, 26 * 54 = 1404MHz
  { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(20), 1200000, 0x03006000}, //0x1B = 27, 27 * 54 = 1458MHz
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(21), 1250000, 0x03006000}, //0x1C = 28, 28 * 54 = 1512MHz
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(22), 1250000, 0x03006000}, //0x1D = 29, 29 * 54 = 1566MHz
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(23), 1250000, 0x03006000}, //0x1E = 30, 30 * 54 = 1620MHz
  ...
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(23), 1350000, 0x03006000}, //0x21 = 33, 33 * 54 = 1782MHz
  { {0, 0}, 0 },
};
